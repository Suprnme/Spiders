const fs = require('fs')
const wasmCode = fs.readFileSync('gv68.wasm')
var window = global;
self = window
...
!function(e) {
    ...
    function a(d) {
        ...
        var b = c[d] = {
          ...
          , t = !0;
        try {
            console.log('需要导出的模块：', d)
            e[d].call(b.exports, b, b.exports, a),
            t = !1
        } finally {
            t && delete c[d]
        }
    ...
    a.d = function(e, c) {
        for (var d in c)
            a.o(c, d) && !a.o(e, d) && Object.defineProperty(e, d, {
                enumerable: !0,
                get: c[d]
            })
    }
    ...
    a.miniCssF = function(e) {
        return "static/css/" + {
            ...
            1348: "759378dd108ef84a",
            1397: "06309bd61b3f9b2b",
            1510: "29341e5c3faacd8f",
            1539: "667efa2e38ed3ea7",
            ...
            2637: "f2d61216829cb0af",
            2655: "e6217b3d9d08b6a0",
            2675: "e700008df541923d",
            2794: "d81bdde1d48a21d8",
            ...
            8440: "1c482f501f86d461",
            8469: "0fd2a74aca746430",
            8479: "69b34b852c5cca6c",
            ...
            if (e[d])
                ...
                if (void 0 !== b)
                    for (var r = document.getElementsByTagName("script"), i = 0; i < r.length; i++) {
                        var u = r[i];
                        if (u.getAttribute("src") == d || u.getAttribute("data-webpack") == c + b) {
                            n = u;
                            break
                        }
                    }
    ...
    function() {
            ...
            return new Promise((function(c, d) {
                ...
                if (function(e, c) {
                    for (var a = document.getElementsByTagName("link"), d = 0; d < a.length; d++) {
                        ...
                        if ("stylesheet" === t.rel && (f === e || f === c))
                            return t
                    }
                    var b = document.getElementsByTagName("style");
                    for (d = 0; d < b.length; d++) {
                        var t;
                        if ((f = (t = b[d]).getAttribute("data-href")) === e || f === c)
                            return t
                    }
                }(f, b))
                    return c();
        ...
        a.f.miniCss = function(a, d) {
            c[a] ? d.push(c[a]) : 0 !== c[a] && {
                100: 1,
                392: 1,
                609: 1,
                794: 1,
                ...
                9476: 1,
                9670: 1
            }[a] && d.push(c[a] = e(a).then((function() {
                c[a] = 0
            }
            ), (function(e) {
                throw delete c[a],
    ...
    function() {
        ...
        a.f.wasm = function(e, c) {
            (n[e] || []).forEach((function(d, f) {
                var n = b[d];
                if (n)
                    c.push(n);
                else {
                    var s, r = t[d](), i = fetch(a.p + "static/wasm/" + {
                        2284: {
                    ...
                    c.push(b[d] = s.then((function(e) {
                        return a.w[d] = (e.instance || e).exports
                    }
                    )))
                }
            }
...
function w() {
            var l = new Int32Array(exportedFunc.memory.buffer);
            return 0 === l.byteLength && (l = new Int32Array(exportedFunc.memory.buffer)),
            l
        };

function c1() {
    o = new Uint8Array(exportedFunc.memory.buffer);
            return 0 === o.byteLength && (o = new Uint8Array(exportedFunc.memory.buffer)),
            o
        };
...
function i(n, e) {
            return u.decode(c1().subarray(n, n + e))
        };
...
var t1 = {
            238464: function() {
                return {
                    "./wasm_api_sign_bg.js": {
                        __wbg_now_513c8208bd94c09b: function() {
                            return e = bc.c[988867].exports,
                            e.ei()

                        },
                        __wbg_random_9f33d5bdc74069f8: function() {
                            return c = bc.c[988867].exports,
                            c.Aw()
                        },
                        __wbg_floor_a68aa7c1b572044e: function(e) {
...
WebAssembly.instantiate(wasmCode, r123).then(
    result => {
        const instance = result.instance;
        exportedFunc = instance.exports;
        // console.log(exportedFunc)
        bc(988867)
        const u = exportedFunc.__wbindgen_add_to_stack_pointer(-16)
                  , c = a("/site/api", exportedFunc.__wbindgen_malloc, exportedFunc.__wbindgen_realloc)
                  , d = f
                  , _ = a("prod", exportedFunc.__wbindgen_malloc, exportedFunc.__wbindgen_realloc)
                  , l = f;
                exportedFunc.sign(u, c, d, _, l);
                var t = w()[u / 4 + 0]
                  , o = w()[u / 4 + 1];
        console.log(i(t, o));
    }
